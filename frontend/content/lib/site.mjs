...
export const ENTITY_SENTENCE = {
  en: `<strong>Mercury</strong> is a free online multiplayer version of the board game <strong>Tock</strong>, sometimes also called <strong>Toc</strong> (in France), <strong>Keezen</strong> (in the Netherlands), <strong>Dog</strong> (in Germany and Switzerland), or <strong>Pegs and Jokers</strong> (in North America). To keep matchmaking simple and fast, this online adaptation is played with 4 players.`,
  fr: `<strong>Mercury</strong> est une version en ligne gratuite et multijoueur du jeu de société du <strong>Tock</strong>, ce jeu est parfois appelé <strong>Toc</strong> (en France), <strong>Keezen</strong> (aux Pays-Bas), <strong>Dog</strong> (en Allemagne et en Suisse) ou <strong>Pegs and Jokers</strong> (en Amérique du Nord). Pour simplifier et fluidifier les matchmakings, cette adaptation en ligne se joue à 4 joueurs.`,
  nl: `<strong>Mercury</strong> is een gratis online multiplayerversie van het bordspel <strong>Tock</strong>, ook wel <strong>Toc</strong> (in Frankrijk), <strong>Keezen</strong> (in Nederland), <strong>Dog</strong> (in Duitsland en Zwitserland) of <strong>Pegs and Jokers</strong> (in Noord-Amerika) genoemd. Om het matchen eenvoudig en vlot te houden, speel je deze online versie met 4 spelers.`,
  de: `<strong>Mercury</strong> ist eine kostenlose Online-Multiplayer-Version des Brettspiels <strong>Tock</strong>, das manchmal auch <strong>Toc</strong> (in Frankreich), <strong>Keezen</strong> (in den Niederlanden), <strong>Dog</strong> (in Deutschland und der Schweiz) oder <strong>Pegs and Jokers</strong> (in Nordamerika) genannt wird. Um das Matchmaking einfach und schnell zu halten, wird diese Online-Version zu viert gespielt.`,
};
